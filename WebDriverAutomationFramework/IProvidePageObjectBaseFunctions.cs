...
namespace WebDriverAutomationFramework
{
    public interface IProvidePageObjectBaseFunctions
    {
        ...
        bool WaitTillSpecifiedCondition(ProvidePageObjectBaseFunctions.ElementProperties validator, TimeSpan timeTillExpiry, string identifier, WebElementType webElementType, string attributeName, string attributeValue);
